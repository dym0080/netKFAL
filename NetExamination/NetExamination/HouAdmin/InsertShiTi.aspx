<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertShiTi.aspx.cs" Inherits="NetExamination.HouAdmin.InsertShiTi" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table style="background-image: url(../igm/在线考试后台1.jpg); width: 998px; height: 621px">
                <tr>
                    <td align="center" colspan="3" style="height: 85px">&nbsp; &nbsp;&nbsp;&nbsp;</td>
                    <td align="center" colspan="1" style="height: 85px"></td>
                </tr>
                <tr>
                    <td style="width: 341px; height: 152px; text-align: left">&nbsp;</td>
                    <td align="right" style="vertical-align: top; width: 1px; height: 152px; text-align: left">&nbsp;<asp:TreeView ID="TreeView1" runat="server" ImageSet="Faq" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged">
                        ...
                        <Nodes>
                            ...
                            <asp:TreeNode NavigateUrl="~/HouAdmin/kaosheng_chengji.aspx" Text="管理考生成绩" Value="管理考生成绩"></asp:TreeNode>
                    ...
                    <td align="left" style="width: 460px; height: 152px; text-align: center"></td>
                </tr>
                <tr>
                    <td style="width: 341px; height: 152px; text-align: left"></td>
                    <td align="right" style="vertical-align: top; width: 1px; height: 152px; text-align: left"></td>
                    <td align="left" style="width: 1080px; height: 152px; text-align: center"></td>
                    <td align="left" style="width: 460px; height: 152px; text-align: center"></td>
                </tr>
            </table>
        </div>
