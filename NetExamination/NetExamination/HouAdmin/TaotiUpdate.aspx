<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaotiUpdate.aspx.cs" Inherits="NetExamination.HouAdmin.TaotiUpdate" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table style="background-image: url(../igm/在线考试后台1.jpg); width: 962px; height: 618px">
                <tr>
                    <td colspan="3" style="height: 74px">&nbsp;<br />
                    </td>
                    <td colspan="1" style="height: 74px"></td>
                </tr>
                <tr>
                    <td style="width: 314px; height: 152px; text-align: left">&nbsp;</td>
                    ...
                    <td align="center" style="width: 729px; height: 152px"></td>
                </tr>
                <tr>
                    <td style="width: 314px; height: 152px; text-align: left"></td>
                    <td align="center" style="vertical-align: top; width: 132px; height: 152px; text-align: left"></td>
                    <td align="center" style="width: 729px; height: 152px"></td>
                    <td align="center" style="width: 729px; height: 152px"></td>
                </tr>
            </table>
