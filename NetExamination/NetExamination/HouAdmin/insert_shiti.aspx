<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="insert_shiti.aspx.cs" Inherits="NetExamination.HouAdmin.insert_shiti" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table style="background-image: url(../igm/在线考试后台1.jpg); width: 1014px; height: 618px">
                <tr>
                    <td colspan="3" style="height: 13px">&nbsp;<br />
                    </td>
                    <td colspan="1" style="height: 13px"></td>
                </tr>
                <tr>
                    ...
                    <br />
                        ...
                        <asp:TreeView ID="TreeView1" runat="server" ImageSet="Faq" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged">
                            ...
                            <Nodes>
                                <asp:TreeNode Expanded="False" NavigateUrl="~/HouAdmin/admin.aspx" Text="管理员" Value="管理员"></asp:TreeNode>
                    ...
                    <td style="width: 462px">&nbsp;<asp:ScriptManager ID="ScriptManager1" runat="server">
                    </asp:ScriptManager>
