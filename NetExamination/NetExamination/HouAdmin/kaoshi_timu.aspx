<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kaoshi_timu.aspx.cs" Inherits="NetExamination.HouAdmin.kaoshi_timu" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table style="background-image: url(../igm/在线考试后台1.jpg); width: 986px; height: 619px">
                <tr>
                    <td colspan="5" style="height: 67px">&nbsp;<br />
                    </td>
                    <td colspan="1" style="height: 67px"></td>
                </tr>
                <tr style="color: #000000">
                    <td align="center" rowspan="2" style="width: 94px; text-align: center">&nbsp;
                    </td>
                    <td align="center" rowspan="2" style="width: 178px; text-align: center"></td>
                    ...
                    <td align="center" style="vertical-align: top; width: 76px; height: 11px; text-align: center"></td>
                    ...
                    <td align="center" style="vertical-align: top; width: 256px; height: 11px; text-align: center"></td>
                </tr>
                <tr>
                    <td style="width: 76px; height: 70px"></td>
                    <td style="width: 256px; height: 70px">&nbsp;</td>
                    <td style="width: 256px; height: 70px"></td>
                </tr>
            </table>
