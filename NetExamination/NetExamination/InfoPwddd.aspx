<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoPwddd.aspx.cs" Inherits="NetExamination.InfoPwddd" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table align="center" style="background-image: url(igm/找回密码.jpg); width: 800px; height: 236px; text-align: center">
            <tr>
                <td colspan="1" style="width: 54px; height: 272px"></td>
                <td colspan="2" style="width: 664px; height: 272px"></td>
            </tr>
            <tr>
            ...
            <tr style="color: #000000">
                <td colspan="1" rowspan="2" style="vertical-align: top; width: 54px; height: 275px"></td>
